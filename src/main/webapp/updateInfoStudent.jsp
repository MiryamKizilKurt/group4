<%-- 
    ...
    Created on : 11-Feb-2023, 5:24:00 PM
    Author     : 236349
--%>
...
<body >
 ...
 <div style="margin: auto;">
        <form method="POST" action="/group4/UpdateInfoStudentServlet">
            <table class ="styled-table" style="margin-left:auto;margin-right:auto;">
                ...
                <tr>
                    ...
                    <td>
                        <a class="btn btn-outline-secondary fs-4" href="user-main.jsp">Student information</a>
