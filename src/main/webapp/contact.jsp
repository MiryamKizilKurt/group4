...
<body>
    ...
    <div class = "pagetitle">
        <h2 style="font-size:3vw">Contact us<sup style="font-size:5vw"> </sup></h2>
    </div>

    <div class = "textformat">
        <p align="justify"> We would love to hear from you - get in touch using one of the contact methods below.<br clear=right>
            <br clear=right>
    ...
    <div class = "textformat1">
        ...
        <a href="https://www.facebook.com/profile.php?id=100089953997828"  border="0" target="_blank" class="social">
            <ion-icon name="logo-facebook"></ion-icon>    
        </a>

        <a href="https://twitter.com/siua2022" target="_blank"  border="0" class="social">
            <ion-icon name="logo-twitter"></ion-icon>
        </a>

        <a href="https://www.instagram.com/siua2022sydney/"  border="0" target="_blank" class="social">
