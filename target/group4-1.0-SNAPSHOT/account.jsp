<%-- 
    Document   : account
    Created on : 31-Jan-2023, 11:39:43 AM
    Author     : 236349
--%>
...
<html>
    ...
    <body onload="startTime()">
                ...
                <div class="navbar-header">
                    <table>
                        <tr>
                            ...
                            <td><a class="button" href="index.jsp">Main-Page</a></td>
        ...
        <div style="margin: auto;">
            <form method="POST" action="/group4/AccountServlet">
                <table class="tab">
                    ...
                    <tr>
                        ...
                        <%}else {%>
                        <td><a class="button" href="index.jsp">Main</a></td>
                        <%}%>
                        <td>
